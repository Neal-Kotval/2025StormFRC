...
public final class Constants {
  ...
  public static class TickValues {
    ...
    public static final double L3ArmTicks = 13.77;
    public static final double L1ElevatorTicks = 8.5;
    public static final double L2ElevatorTicks = 19.30;
    public static final double L3ElevatorTicks = 43.36;
  }
