...
public final class LimelightUtil {
    private static final NetworkTable LIMELIGHT_NT = Constants.NT_INSTANCE.getTable(Constants.VisionConstantsTest.LimelightConstants.LIMELIGHT_NT_NAME);
    ...
    public static boolean isTagClear() {
        return tagExists() && getNearestTagDist() < Constants.VisionConstantsTest.LimelightConstants.LL_MAX_TAG_CLEAR_DIST;
    }

    public static void configureRobotToCameraOffset() {
        LIMELIGHT_NT.getEntry("camerapose_robotspace_set").setDoubleArray(
                new double[]{
                        Constants.VisionConstantsTest.LimelightConstants.LL_FORWARD,
                        Constants.VisionConstantsTest.LimelightConstants.LL_RIGHT,
                        Constants.VisionConstantsTest.LimelightConstants.LL_UP,
                        Constants.VisionConstantsTest.LimelightConstants.LL_ROLL,
                        Constants.VisionConstantsTest.LimelightConstants.LL_PITCH,
                        Constants.VisionConstantsTest.LimelightConstants.LL_YAW
                }
        );
    }
